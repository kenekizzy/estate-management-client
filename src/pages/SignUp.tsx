...
const SignUp: React.FC = () => {
    ...
    const submitForm = async (data: SignUpFormData) => {
        ...
        try {
            ...
            dispatch(signInFailure(err.response?.data?.message || "Sign up failed"))
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8 bg-gray-50">
            <div className="w-full max-w-lg space-y-8 bg-white p-8 rounded-2xl shadow-lg">
                <div>
                    <h2 className="text-4xl font-bold text-center text-gray-900 tracking-tight">Create Account</h2>
                            ...
                            <div className="mt-1">
                                <input
                                    ...
                                    {...register("username", {
                                        ...
                                        maxLength: { value: 40, message: "Username should have a max length of 40 characters" }
                                    })}
                                />
                                {errors.username && (
                                ...
                                <input
                                    ...
                                    {...register("password", {
                                        ...
                                        pattern: {
                                            ...
                                            message: "Password must contain one uppercase, one lowercase, one number and a special character"
                                        }
                                    })}
                                />
                                <div
                ...
                <div className="text-center text-sm">
                    <p className="text-gray-600">
                        ...
                        <Link to="/sign-in" className="font-medium text-slate-700 hover:text-slate-900 transition-colors duration-200">
                            Sign in instead
                        </Link>
                    </p>
                </div>
